...
class DatabaseQueryApp:
    ...
    def create_widgets(self):
        ...
        # Minute spinbox
        self.start_minute = tk.StringVar(value="07")
    ...
    def query_and_export(self):
        ...
        try:
            # Build full start/end datetime from calendar + spinboxes
    ...
    def validate_dates(self):
        """
        Validate that the constructed start datetime is before the end datetime.
        """
        try:
